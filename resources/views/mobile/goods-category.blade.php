...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/mobile/styles/goods-category.css">
</head>

<body class="search hide-mask goods-category-input">
    ...
    <script type="text/javascript" src="/mobile/scripts/dist/goods-category.js"></script>
</body>
